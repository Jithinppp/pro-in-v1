...
const APP_TAGLINE = process.env.NEXT_PUBLIC_APP_TAGLINE || "Asset Management System";
    ...
    <div className="min-h-screen w-full flex">
      ...
      <div className="w-full lg:w-[48%] bg-white flex items-center justify-center p-8 lg:p-16">
        <div className="w-full max-w-sm">
          <div className="mb-12">
            <h2 className="text-2xl font-semibold tracking-tight text-[#18181b] mb-3">Sign in</h2>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <p className="text-center text-xs text-[#a1a1aa]">Secured by Supabase Auth</p>
          </form>
        </div>
      </div>
    </div>
